...
INCLUDE_PATHS = -I. -I$(RAYLIB_PATH)/src -I$(RAYLIB_PATH)/src/external -I$(RAYLIB_H_INSTALL_PATH)
...
$(PROJECT_NAME): $(OBJS) $(OBJS2)
	$(CC) -o $(PROJECT_NAME)$(EXT) $(OBJS) $(OBJS2) $(CFLAGS) $(INCLUDE_PATHS) $(LDFLAGS) $(LDLIBS) -D$(PLATFORM)
